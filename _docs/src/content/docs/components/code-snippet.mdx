...
- **[`CodeDiff`](/components/code-diff/)** — reach for it when the point is what changes, not what is there.
- A plain fenced block — reach for it when the code has no file identity.
