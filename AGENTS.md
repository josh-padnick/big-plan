...
- The npm release, promotion, and rollback procedure, and the changelog discipline that release follows, live in [RELEASING.md](RELEASING.md); the release history a reader sees lives in [CHANGELOG.md](CHANGELOG.md); the branch and pull-request dispositions the launch tag is cut from live in [RELEASING-pr-hygiene.md](RELEASING-pr-hygiene.md).
