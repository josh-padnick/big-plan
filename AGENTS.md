...
The static subset rejects imports, exports, expressions, and unsupported attributes with hard-fail diagnostics carrying line and column positions, while the built-in Callout, CodeDiff, CodeSnippet, FileTree, FileTreeDiff, GraphqlOperation, GrpcMethod, and HttpEndpoint components provide validated plan-native presentation.
...
HttpEndpoint renders always-expanded API review cards with validated parameters, request examples, and response contracts.
