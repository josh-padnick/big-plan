...
Big Plan renders a markdown plan file into one self-contained HTML document your human reviews, so you reach agreement before you act.
...
1. Write your implementation plan to a markdown file, for example `plan.md`.
2. Run `big-plan render plan.md`.
...
```text
Before implementing a feature, write your implementation plan to plan.md,
render it with `big-plan render plan.md`, and ask for review of the
...
- https://big-plan.ai/for-agents.md - the operational rendering workflow.
- https://big-plan.ai/guides/authoring-plans.md - the plan document format.
