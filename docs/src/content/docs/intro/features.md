...
- An **Inputs** list names everything the review is still waiting for - every open decision and every published change set - with each one marked answered, not answered, or stale, and the decisions the plan's author called critical marked as such.
