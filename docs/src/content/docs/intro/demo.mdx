...
<Tabs>
  ...
  <TabItem label="Dark appearance">
    ![The example plan rendered with Big Plan's Default colour theme in its dark appearance, with the same layout on dark shades.](../../../assets/viewer-full-dark.png)
  </TabItem>
</Tabs>
...
For what every control in a live review does, read [the tour](/intro/tour/).
