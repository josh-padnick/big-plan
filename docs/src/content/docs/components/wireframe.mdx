...
Desktop application shells instead hold a 1200 × 820 workspace viewport: persistent panes own their overflow while the app itself never scrolls sideways.
...
| ----------------- | --------------------------------- | --------------------- |
| `desktop`         | 1200 × 820 px minimum              | Desktop browser; an `AppShell` holds the viewport |
