...
Its caption keeps that screen name on the left and its device and viewport description on the right, aligned to the frame at rest and while maximized, even when the wireframe contains only one screen.
