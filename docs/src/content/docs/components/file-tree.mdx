...
- **[`FileTreeDiff`](/components/file-tree-diff/)** — reach for it when entries carry added, modified, removed, or renamed status. `FileTree` rejects change badges and points you there.
