...
A live titled hierarchy with folder and file icons, connector lines, and a muted note beside each file - click the folder row to fold it, or use the header controls:

<ThemeFrame
  light="/embeds/file-tree-plain-light.html"
  dark="/embeds/file-tree-plain-dark.html"
  title="A titled plain file hierarchy with folder and file icons, connector lines, and a muted note beside each file"
  height="12.5rem"
/>
