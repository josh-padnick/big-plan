---
title: FileTreeDiff
description: A component for a project file hierarchy annotated with per-entry change status, viewable as a combined tree or side-by-side before and after trees.
---
...
| ---------- | ------------------ | -------- | ------------------------------------------------------------------------------ |
| `title`    | string (non-empty) | No       | Header and full-screen dialog caption; omitted, the summary and controls remain. |
