---
title: FileTreeDiff
description: A component for a project file hierarchy annotated with per-entry change status in one combined tree.
---
...
It derives the complete transition from one authored change tree and renders it as a combined view.
...
| `hideDiff` | bare boolean       | No       | Preserved in the compiled model for the forthcoming live review application.  |
...
Alternate before-and-after views, folding, and full-screen viewing belong to the forthcoming live review application.
