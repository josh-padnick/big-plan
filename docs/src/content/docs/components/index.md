...
| [Flow](/components/flow/)                                 | Diagram a flow, dependency, or fan-out as staged cards joined by verb-labeled, directed connectors.                  |
