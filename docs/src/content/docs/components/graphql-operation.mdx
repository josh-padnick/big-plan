...
- **[`HttpEndpoint`](/components/http-endpoint/)** and **[`GrpcMethod`](/components/grpc-method/)** — the same card shape for the other two transports.

## Use cases

- Propose a new mutation with its input, payload convention, and an executable example operation
