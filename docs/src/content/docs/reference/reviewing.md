...
Sending new work on a resolved thread - a reply, or feedback that includes that thread - reopens it immediately.
The event trail records that it reopened because new work arrived.
