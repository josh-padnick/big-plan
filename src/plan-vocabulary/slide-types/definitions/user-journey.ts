...
export const USER_JOURNEY_SLIDE_TYPE = {
  ...
  guidance: [
    ...
    "Open the container with an intro slide that introduces the actors: one bullet per actor carrying its journey count, a sub-bullet naming what that actor does, a closing line saying what the journeys share, and a jump line linking each journey by the slug of its h2; title that slide with its claim rather than restating the container name.",
