// Claude brand mark, unmodified path data from Font Awesome Free 7.2.0
// (svgs/brands/claude.svg). Font Awesome Free icons are licensed CC BY 4.0:
// https://fontawesome.com/license/free
// Source: https://fontawesome.com/icons/claude
// "Claude" is a trademark of Anthropic, PBC; this mark identifies the vendor
// of a connected model and claims no other affiliation.

import type { BrandIcon } from "../brand-icon.js";

export const CLAUDE_ICON: BrandIcon = {
  name: "claude",
  viewBox: "0 0 512 512",
  node: [
    [
