...
describe("compileMarkdown static MDX validation", () => {
  ...
  it("should render MDX-compatible GFM features without changing their HTML", () => {
    expect(
      ...
      '<h1 id="plan" data-block-id="document/heading-1" data-block-kind="heading" data-block-label="Plan">Plan</h1>\n' +
        '<p data-block-id="document/paragraph-1" data-block-kind="paragraph" data-block-label="A safe link.">A <strong>safe</strong> <a href="https://example.com">link</a>.</p>',
    );
  });
});
