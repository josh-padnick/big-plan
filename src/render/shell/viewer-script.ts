...
// column layout and grouping, wireframe navigation and true-width scaling, and
// one maximize behavior shared by every figure family, a decision matrix's
// column highlight, rationale swap, and confirm step, plus the diagram leg in
