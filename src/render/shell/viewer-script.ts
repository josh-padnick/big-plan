...
// positioned to stay inside the viewport, collapse toggles for deck parts,
// slides, and sub-slides, and wireframe screen navigation driven entirely by
// data attributes the renderer emitted. Plan content never contributes
