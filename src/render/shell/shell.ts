...
const renderPreferencesDialog = (): string =>
  `<div class="fixed inset-0 z-50 flex items-end justify-center bg-black/70 p-3 wide:grid wide:place-items-center wide:p-4" data-preferences-backdrop hidden>
