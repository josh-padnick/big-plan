...
<p class="mt-2 text-xs leading-normal text-muted" id="big-plan-approval-message-hint">Your recorded answers are always attached. This text is the covering note the agent receives when you approve.</p>
