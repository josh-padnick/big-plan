...
describe("renderDocument affordances", () => {
  ...
  it("should emit markup for every GFM affordance when the fixture uses them all", () => {
    const expectedFragments = [
      ...
      "<h5",
      "<h6",
      "<p data-authored-prose",
      "<em data-authored-prose",
      "<strong data-authored-prose",
      "<del data-authored-prose",
      "<code data-authored-prose",
      "<pre",
      "<blockquote data-authored-prose",
      "<ul data-authored-prose",
      "<ol data-authored-prose",
      'input type="checkbox"',
      TABLE_SCROLL_CONTAINER,
      'href="https://example.com/docs"',
      '<img src="data:image/png;base64,',
      "<hr data-authored-prose",
      'class="footnotes"',
    ];
...
`;
  ...
  it("should inline the stylesheet and viewer scripts when rendering", () => {
    ...
    expect(html.match(/<script\b[^>]*>[\s\S]*?<\/script>/g)).toHaveLength(4);
