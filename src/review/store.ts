// Owns review paths, directory custody, locks, and stored review records.
// Agent presence, progress logs, and file publication have dedicated owners
// beside this file; this module does not define their lifecycle policies.
//
...
import { PROGRESS_TEXT_LIMIT } from "./shared/progress-code.js";
import {
  FILE_MODE,
  publishedJsonFileNames,
  readStoreJson,
  writeStoreJson,
} from "./store-files.js";
