...
import { PlanLossEvidence } from "./plan-loss-evidence.browser.js";
import {
  blockKind,
  blockAddressId,
  diffSideOfElement,
  ...
  targetElement,
  liveTargetBlock,
  targetAssociationElements,
  targetAddress,
  selectionRange,
  selectionTargetResolves,
  targetHighlightRange,
  setSelectionHighlights,
} from "./comment-target.browser.js";
import type {
  SelectionTarget,
  SelectionControlState,
} from "./comment-target.browser.js";
