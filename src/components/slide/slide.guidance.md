...
An untyped “User journeys” slide is still a valid container when every journey fits an h3 sub-slide of it, which trades those marker affordances for a shorter section.
