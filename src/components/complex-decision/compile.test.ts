// Tests ComplexDecision's pure criteria-matrix compiler and end-to-end positional
...
const compile = ({
  ...
  const model = compileComplexDecisionComponent({
    attributes,
    children,
    scopedChildren,
    position: POSITION,
...
describe("compileComplexDecisionComponent", () => {
    ...
    expect(diagnostics).toEqual([
      {
        line: 3,
        column: 1,
        message: 'Duplicate Criterion title "Setup" in ComplexDecision',
      },
    ]);
  });
  ...
  it("should reject option and criterion titles duplicated by whitespace", () => {
    ...
    expect(diagnostics).toEqual([
      ...
      },
      {
        line: 8,
        column: 1,
        message: 'Duplicate Option title "A" in ComplexDecision',
      },
    ]);
  });
...
describe("ComplexDecision end-to-end diagnostics", () => {
