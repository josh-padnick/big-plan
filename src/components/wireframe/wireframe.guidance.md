...
- Selection decorates, never deforms. Paint engagement around the selected object with an outline or a border whose transparent width was reserved before selection; inherit that object's corner shape and never sweep adjacent captions or controls into the selection. Never change the artboard's box size, overflow geometry, fitted scale, or internal layout to communicate selection.
