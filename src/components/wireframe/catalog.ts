...
const CATALOG = {
  ...
  Panel: {
    ...
    acceptsChildren: true,
    summary:
      'A region that draws no box by default. In a Row, span=list|main|rail sets workspace proportions; surface="filled" marks a pane and surface="outlined" is for a card.',
