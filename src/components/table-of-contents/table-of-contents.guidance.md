...
- Write one `<Entry section="..." gist="..." />` per section, in document order; `section` repeats the catalog name for a typed slide and the h2 title for an untyped slide, and lint verifies the 1:1 match.
