...
| Style the view                       | `view.tsx`, rarely `styles.css`             | Tailwind utilities on the markup the view renders. A `styles.css` file is the bounded escape hatch [ENGINEERING_PRACTICES.md](../../ENGINEERING_PRACTICES.md) defines, not the default home for a component's styles. |
