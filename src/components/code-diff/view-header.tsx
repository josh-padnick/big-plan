...
export const CodeDiffHeader = ({
  ...
  <figcaption className="code-diff-header flex min-w-0 items-center justify-between gap-3 rounded-t-[calc(var(--radius-md)-1px)] bg-[var(--diff-header-bg)] px-2 py-1">
